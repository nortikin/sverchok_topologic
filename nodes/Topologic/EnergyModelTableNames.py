...
class SvEnergyModelTableNames(SverchCustomTreeNode, bpy.types.Node):
    ...
    def process(self):
        ...
        self.outputs['Table Names'].sv_set(outputs)

def register():
    bpy.utils.register_class(SvEnergyModelTableNames)

def unregister():
    bpy.utils.unregister_class(SvEnergyModelTableNames)
