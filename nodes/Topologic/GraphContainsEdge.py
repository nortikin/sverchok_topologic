...
class SvGraphContainsEdge(SverchCustomTreeNode, bpy.types.Node):
	"""
	Triggers: Topologic
	Tooltip: Outputs True if the input Graph contains the input Edge. Outputs False otherwise.
	"""
	bl_idname = 'SvGraphContainsEdge'
	bl_label = 'Graph.ContainsEdge'
...
def register():
    bpy.utils.register_class(SvGraphContainsEdge)

def unregister():
    bpy.utils.unregister_class(SvGraphContainsEdge)
