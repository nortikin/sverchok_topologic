...
class SvGraphRemoveEdge(SverchCustomTreeNode, bpy.types.Node):
	"""
	Triggers: Topologic
	...
	def process(self):
		...
		if ((self.Replication) == "Default"):
			...
			print("Graph Remove Edge Operation consumed "+str(round(end - start,4))+" seconds")
			return
		...
		print("Graph Remove Edge Operation consumed "+str(round(end - start,4))+" seconds")
def register():
    bpy.utils.register_class(SvGraphRemoveEdge)

def unregister():
    bpy.utils.unregister_class(SvGraphRemoveEdge)
