...
class SvSpeckleCommitByURL(SverchCustomTreeNode, bpy.types.Node):
	...
	"""
	bl_idname = 'SvSpeckleCommitByURL'
	bl_label = 'Speckle.CommitByURL'
...
def register():
    bpy.utils.register_class(SvSpeckleCommitByURL)

def unregister():
    bpy.utils.unregister_class(SvSpeckleCommitByURL)
