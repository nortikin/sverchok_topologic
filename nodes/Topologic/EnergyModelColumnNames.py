...
class SvEnergyModelColumnNames(SverchCustomTreeNode, bpy.types.Node):
    """
    Triggers: Topologic
    Tooltip: Returns the columns names from the input energy model, report name, and table name
    """
    bl_idname = 'SvEnergyModelColumnNames'
    bl_label = 'EnergyModel.ColumnNames'
    ...
    def sv_init(self, context):
        ...
        self.outputs.new('SvStringsSocket', 'Column Names')
    ...
    def process(self):
        ...
        self.outputs['Column Names'].sv_set(outputs)

def register():
    bpy.utils.register_class(SvEnergyModelColumnNames)

def unregister():
    bpy.utils.unregister_class(SvEnergyModelColumnNames)
