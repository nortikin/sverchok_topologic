...
class SvSpeckleClientByURL(SverchCustomTreeNode, bpy.types.Node):
	"""
	Triggers: Topologic
	Tooltip: Retrieves the Speckle Client from the input URL   
	"""
	bl_idname = 'SvSpeckleClientByURL'
	bl_label = 'Speckle.ClientByURL'
...
def register():
    bpy.utils.register_class(SvSpeckleClientByURL)

def unregister():
    bpy.utils.unregister_class(SvSpeckleClientByURL)
